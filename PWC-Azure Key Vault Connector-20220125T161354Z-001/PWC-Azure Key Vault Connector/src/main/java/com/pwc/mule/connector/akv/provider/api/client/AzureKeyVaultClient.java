...
public class AzureKeyVaultClient extends AzureClient {
   ...
   */
  public SecretList getSecretList(String maxResults) throws DefaultMuleException {
	    HttpRequest request = getAuthenticatedHttpRequestBuilder()
	        .uri(getHttpBaseUri() + BASE_SECRET_PATH + maxResults)
	    ...
	    try {
	      ...
	      LOGGER.error("Error retrieving secret at " + maxResults, e);
	      throw new DefaultMuleException("Error retrieving secret at " + maxResults, e);
	    }
	  }
